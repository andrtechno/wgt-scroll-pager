    ...
    this.load = function(url, callback, delay) {
      ...
      function xhrDoneCallback(data) {
        ...
        if ($itemContainer) {
          ...
          //var pager = [];
          //$itemContainer.find('.pagination li').each(function() {
            //pager.push(this);
          //});
          /*if(pager){
  var pagination = $(this.paginationSelector).eq(0).html('');
  $.each(pager, function(i, pageItem) {
    pagination.append(pageItem);
  });
}*/
          $(this.paginationSelector).eq(0).replaceWith($itemContainer.find('.pagination'));
        }
